...
#
# Generated by Vivado on Wed Jul 10 20:44:04 +0700 2024
...
copy_setup_file()
{
  ...
  if [[ ($1 != "") ]]; then
    ...
    lib_map_path="D:/SUSTech/Year 2 Semester 2/CS202 - Computer Organization/Project/GitHub/RISC-V-CPU/cpu-verilog/Final_CPU/Final_CPU.cache/compile_simlib/activehdl"
  fi
